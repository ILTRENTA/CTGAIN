...
class NullTransformer():
    ...
    def reverse_transform(self, data):
 	...
 	# if self.nulls and isna.any(): ## commenting this part is a temporary fix for the issue
        #     data.loc[isna] = np.nan ## doing this avoids nan values to be randomly inserted in the data once we 
        #     ## reverse transform them. 
        return data
