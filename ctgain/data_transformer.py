...
ColumnTransformInfo = namedtuple(
    'ColumnTransformInfo', [
        'column_name', 'column_type', 'transform', 'output_info', 'output_dimensions', "mask"
    ]
)


class DataTransformer_with_masking_nas(object):
    """Data Transformer.
    ...
    def _fit_discrete(self, data):
        ...
        return ColumnTransformInfo(
            ...
            output_dimensions=num_categories, mask=mask)
    ...
    def _transform_continuous(self, column_transform_info, data):
        ...
        mask_vect_trans
        # output[mask]=np.nan ###### adding masking for eventual use
    ...
    def _synchronous_transform(self, raw_data, column_transform_info_list):
        ...
        for column_transform_info in column_transform_info_list:
            ...
            if column_transform_info.column_type == 'continuous':
                out, mask=self._transform_continuous(column_transform_info, data)
    ...
    def transform(self, raw_data):
        ...
        if raw_data.shape[0] < 500:
            column_data_list, mask_list = self._synchronous_transform(
                raw_data,
                self._column_transform_info_list
            )
        else:
